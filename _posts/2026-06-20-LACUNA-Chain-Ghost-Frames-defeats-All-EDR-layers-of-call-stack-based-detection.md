---
layout: post
title: "LACUNA Chain: Ghost Frames — defeats all EDR layers of call-stack-based detection"
date: 2026-06-20
categories: [Maldev, Evasion]
tags: [Evasion, EDR, Call-Stack, BYOUD, Windows-Internals]
---
...
![LACUNA Chain — EDR Detection Layer Coverage](/assets/img/lacuna/01_lacuna_edr_coverage.png)
...
![HookChain Part I vs LACUNA Chain Part II](/assets/img/lacuna/diagrams/01_hookchain_part_i_lacuna_chain_part_ii.png)
...
![Kernel Callback Architecture](/assets/img/lacuna/02_kernel_callbacks.png)
...
![Why HookChain Is No Longer Enough](/assets/img/lacuna/diagrams/02_why_hookchain_no_longer_enough.png)

The new problem: how to make that collected stack look legitimate.

![ETW-Ti STACKWALK Killing HookChain](/assets/img/lacuna/03_etw_ti_stackwalk.png)
...
![.pdata Section Layout](/assets/img/lacuna/diagrams/03_pdata_section_layout.png)
...
![.pdata Coverage Map](/assets/img/lacuna/diagrams/04_pdata_coverage_map_of_a_typical_dll.png)
...
![ETW-Ti Stack Collection Timeline](/assets/img/lacuna/diagrams/05_etw_ti_stack_collection_timeline.png)
...
![Evolution of Call-Stack Evasion](/assets/img/lacuna/diagrams/06_evolution_of_call_stack_evasion.png)
...
![Call-Stack Evasion Generations](/assets/img/lacuna/04_evasion_generations.png)
...
![BYOUD-Gap Hiding Shellcode Frames](/assets/img/lacuna/diagrams/07_byoud_gap_hiding_3_real_shellcode_frames.png)
...
![ntdll.dll .pdata Gap Classification](/assets/img/lacuna/diagrams/08_ntdll_dll_pdata_gap_classification.png)
...
![Detection Matrix for BYOUD-Gap](/assets/img/lacuna/diagrams/09_detection_matrix_for_byoud_gap.png)

![BYOUD-Gap vs Prior Techniques](/assets/img/lacuna/05_byoud_gap_comparison.png)
...
![ETW-Ti APC Window Exploitation](/assets/img/lacuna/diagrams/10_etw_ti_apc_window_exploitation.png)
...
![How BYOUD Defeats CET](/assets/img/lacuna/diagrams/11_how_byoud_defeats_cet.png)
...
![win32u.dll Stub Layout](/assets/img/lacuna/diagrams/12_win32u_dll_stub_layout_every_entry_no_exceptions.png)
...
![UWOP_PUSH_MACHFRAME Handler](/assets/img/lacuna/diagrams/13_uwop_push_machframe_handler_from_ghidra_decompile.png)
...
![FAKE_MACHFRAME Layout](/assets/img/lacuna/diagrams/14_fake_machframe_layout_op_info_0_no_error_code.png)
...
![Parameter Encryption Flow](/assets/img/lacuna/diagrams/15_parameter_encryption_flow.png)
...
![The LACUNA Chain — Six-Layer Architecture](/assets/img/lacuna/diagrams/16_lacuna_chain_six_layer_table.png)
...
![LACUNA Chain — Six Layer Architecture](/assets/img/lacuna/06_lacuna_chain_layers.png)
...
![LACUNA Chain — All Call-Stack Detection Layers Defeated](/assets/img/lacuna/07_all_layers_defeated.png)
...
![Lab Results — Technique vs Detection Layer](/assets/img/lacuna/08_lab_results_matrix.png)
...
![Detection Architecture — Post-BYOUD-Gap](/assets/img/lacuna/diagrams/17_detection_architecture_post_byoud.png)
...
![Detection Architecture — Post-BYOUD-Gap](/assets/img/lacuna/09_detection_architecture.png)
...
**[1]** Helvio Carvalho Junior — *"HookChain: A New Perspective for Bypassing EDR Solutions"* — [arXiv:2404.16856](https://arxiv.org/abs/2404.16856) · DEF CON 32, August 2024

**[2]** Mohamed Alzhrani — *"HookChain: A Deep Dive into Advanced EDR Bypass Techniques"* — [0xmaz.me](https://0xmaz.me/posts/HookChain-A-Deep-Dive-into-Advanced-EDR-Bypass-Techniques/) · October 2024 · Part I of this series

**[3]** WithSecure Labs — *"Spoofing Call Stacks to Confuse EDRs"* — [WithSecure](https://labs.withsecure.com/publications/spoofing-call-stacks-to-confuse-edrs) · June 2022
...
**[6]** klezVirus — *"Fantastic Unwind Information and Where to Find Them" (BYOUD)* — [Blog](https://klezvirus.github.io/posts/Byoud/) · Black Hat Europe 2025
...
**[9]** Synacktiv — *"Windows Kernel Shadow Stack Mitigation"* — [SSTIC 2025](https://www.synacktiv.com/sites/default/files/2025-06/sstic_windows_kernel_shadow_stack_mitigation.pdf)

**[10]** Connor McGarr — *"Kernel-Mode Shadow Stacks"* — [Blog](https://connormcgarr.github.io/km-shadow-stacks/)

**[11]** Volexity / Andrew Case — *"EDR Evasion and Detection"* — [DEF CON 32](https://www.volexity.com/wp-content/uploads/2024/08/Defcon24_EDR_Evasion_Detection_White-Paper_Andrew-Case.pdf)

**[12]** WhiteKnightLabs — *"LayeredSyscall: Abusing VEH to Bypass EDRs"* — [Blog](https://whiteknightlabs.com/2024/07/31/layeredsyscall-abusing-veh-to-bypass-edrs/)

**[13]** Elastic Security Labs — *"Doubling Down: ETW Call Stacks"* — [Elastic](https://www.elastic.co/security-labs/doubling-down-etw-callstacks)

**[14]** Gkritsis et al. — *"Evading and Crashing Anti-Malware Solutions via Data Collection Overloading"* — [arXiv:2511.04472](https://arxiv.org/abs/2511.04472)

**[15]** Praetorian — *"ETW Threat Intelligence and Hardware Breakpoints"* — [Blog](https://www.praetorian.com/blog/etw-threat-intelligence-and-hardware-breakpoints/)

---

*All techniques described here are documented for security research and detection engineering purposes. The BYOUD-Gap technique, ETW-Ti APC window exploitation, Win32u NOP Gap Chain, Ghost Gadget discovery, BYOUD-MF, BYOUD-RT, and kernelbase Semantic Ghost Proximity are original contributions by the author, derived from binary analysis of Windows system DLLs extracted from a controlled lab environment.*
